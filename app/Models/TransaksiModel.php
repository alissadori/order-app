...
class TransaksiModel extends Model
{
    ...
    function getChartData()
    {
        ...
        // $bulan = $this->request->getPost();
        // $db = \Config\Database::connect();

        // $query = $db->query(" SELECT created_at AS tgl, total FROM transaksi_detail WHERE DATE_FORMAT(created_at, '%Y-%m') = '$bulan' ORDER BY created_at ASC")->getResult();
